...
const client = contentful.createClient(
  {
    accessToken: process.env.CONTENTFUL_MANAGEMENT_TOKEN!, // This is the Contentful Management API token
    space: process.env.CONTENTFUL_SPACE_ID!, // This is the Contentful space ID
  },
  {
    type: "plain",
    defaults: {
