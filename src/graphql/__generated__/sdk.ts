...
export function getSdk(
  ...
  return {
    getAppSettings(
      variables?: GetAppSettingsQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<{
      data: GetAppSettingsQuery;
      errors?: GraphQLError[];
      extensions?: any;
      headers: Headers;
      status: number;
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.rawRequest<GetAppSettingsQuery>(
            GetAppSettingsDocumentString,
            variables,
